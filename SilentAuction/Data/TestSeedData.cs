...
namespace SilentAuction.Data
{
    public class TestSeedData
    {
        public static void Initialize(AuctionContext context)
        {
            ...
            context.Catagories.Add(entertainmentCatagory);

            var lifestyleCatagory = new Catagory { Name = "Lifestyle" };
            context.Catagories.Add(lifestyleCatagory);
            context.SaveChanges();
            ...
            {
                // Accommodation
                new Item { Name = "2 Nights Accommodation in an Ocean View Pool Villa at Trisara", Description = "Enjoy a two night stay in a spectacular Ocean View Pool Villa at Trisara, inclusive of 2x Trisara spa treatments, daily breakfast and the Trisara Sunday Jazz Brunch for 2.", Catagory = accommodationCatagory, RetailPrice = 100, SponsorId = sponsors[0].Id, Sponsor = sponsors[0]},
                new Item { Name = "2 Nights Accommodation at Le Meridien Phuket Beach Resort + 2 Dinners", Description = "Enjoy a 3 day 2 night stay for two persons at the Le Meridien Phuket Beach Resort in an Ocean Front Deluxe Suite including daily buffet breakfast and one dinner at Portofino including a bottle of house wine and one dinner at Ariake including a carafe of Sake.", Catagory = accommodationCatagory, RetailPrice = 60, SponsorId = sponsors[1].Id, Sponsor = sponsors[1]},
                new Item { Name = "1 Night Accommodation at Andara Resort + In-Suite BBQ w/ Champagne", Description = "Enjoy a 1-night stay in a 4-bedroom Pool Suite at Andara Resort & Villas with daily breakfast at SILK Restaurant and a BBQ for 8 persons in your Suite Room with your own private chef accompanied by 2 bottles of Louis Roederer Champagne.", Catagory = accommodationCatagory, RetailPrice = 60, SponsorId = sponsors[2].Id, Sponsor = sponsors[2]},
                new Item { Name = "3 Nights Accommodation at The Surin Phuket", Description = "Enjoy a 3 night stay for two persons at The Surin Phuket in a Beach Deluxe Suite including daily buffet breakfast with signature dinner & spa treatment.", Catagory = accommodationCatagory, RetailPrice = 60, SponsorId = sponsors[3].Id, Sponsor = sponsors[3]},
                new Item { Name = "2 Nights Accommodation at Mövenpick Resort, Bangtao Beach Phuket", Description = "Enjoy a 2-night stay in a Seaview Pool Suite 1 Bedroom inclusive of breakfast for two at The Palm Cuisine at the Mövenpick Resort, Bangtao Beach Phuket.", Catagory = accommodationCatagory, RetailPrice = 60, SponsorId = sponsors[4].Id, Sponsor = sponsors[4]},

                // Advertising
                new Item { Name = "Half Page Advert in Khao Phuket (The Phuket News in Thai)", Description = "Receive one 1/2 page advertisement — 274mm (w) x 189mm (h) – in Khao Phuket (The Phuket News in Thai), including artwork and translation.", Catagory = advertisingCatagory, RetailPrice = 60, SponsorId = sponsors[5].Id, Sponsor = sponsors[5]},
                new Item { Name = "Half Page Advert in Novosti Phuket (The Phuket News in Russian)", Description = "Receive one 1/2 page advertisement — 274mm (w) x 189mm (h) – in Novosti Phuket (The Phuket News in Russian), including artwork and translation.", Catagory = advertisingCatagory, RetailPrice = 60, SponsorId = sponsors[6].Id, Sponsor = sponsors[6]},
                new Item { Name = "TV Advertisement in The Phuket News TV", Description = "Receive a 1 month x 10 second fixed graphic advertisement on The Phuket News TV.", Catagory = advertisingCatagory, RetailPrice = 60, SponsorId = sponsors[7].Id, Sponsor = sponsors[7]},

                // Dining (+Accomodation +Lifestyle)
                new Item { Name = "Eternity Spa Package (3.5 hrs) and Set Dinner for 2 at Burasari Resort, Phuket", Description = "Enjoy an Eternity Spa Package (lasting three and a half hours) as well as a set dinner for 2 persons at the Burasari Resort in Patong, Phuket.", Catagory = diningCatagory, RetailPrice = 60, SponsorId = sponsors[8].Id, Sponsor = sponsors[8]},
                new Item { Name = "THB 5,000 Voucher for use The Siam Supper Club", Description = "The winning bidder will get to enjoy THB 5,000 during a dining and/or drinking experience at The Siam Supper Club.", Catagory = diningCatagory, RetailPrice = 60, SponsorId = sponsors[9].Id, Sponsor = sponsors[9]},

                // Entertainment
                new Item { Name = "Nuvo AccentPLUS1 6.5″ In-Ceiling Speakers", Description = "Fill the room with impeccably clean, full sound with this set of Nuvo AccentPLUS1 6.5″ In-Ceiling Speakers.", Catagory = entertainmentCatagory, RetailPrice = 60, SponsorId = sponsors[10].Id, Sponsor = sponsors[10]},

                // Lifestyle (+Dinning, + Accomodation)
                new Item { Name = "2 Nights Accommodation at Novotel Phuket Kamala Beach + Dinner + Spa", Description = "Enjoy a 3 day 2 night stay for two persons at the Novotel Phuket Kamala Beach in a One Bedroom Pool Villa including daily breakfast, a romantic dinner for 2 at On The Roof and a one hour spa treatment for 2.", Catagory = lifestyleCatagory, RetailPrice = 60, SponsorId = sponsors[11].Id, Sponsor = sponsors[11]},
            };

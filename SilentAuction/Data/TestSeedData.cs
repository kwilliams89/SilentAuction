    ...
    public class TestSeedData
    {
        public static void Initialize(AuctionContext context)
        {
            ...
            var items = new Item[]
            {
                ...
                // Lifestyle (+Dinning, + Accomodation)
                new Item { Name = "2 Nights Accommodation at Novotel Phuket Kamala Beach + Dinner + Spa", Description = "Enjoy a 3 day 2 night stay for two persons at the Novotel Phuket Kamala Beach in a One Bedroom Pool Villa including daily breakfast, a romantic dinner for 2 at On The Roof and a one hour spa treatment for 2.", Category = lifestyleCategory, RetailPrice = 60, SponsorId = sponsors[11].Id, Sponsor = sponsors[11]},
            };
